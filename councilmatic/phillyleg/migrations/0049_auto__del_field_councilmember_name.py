...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CouncilMember.name'
        db.delete_column(u'phillyleg_councilmember', 'name')

    def backwards(self, orm):
        # Adding field 'CouncilMember.name'
        db.add_column(u'phillyleg_councilmember', 'name',
